...
ficheiro_txt = r"C:\Users\Utilizador\Desktop\CanSat\LimaSat25\dados-gráfico\dados"
...
def ler_dados():
    ...
    try:
        df = pd.read_csv(ficheiro_txt, header= None, names=["Temperatura", "Pressão","UV1","UV2","UV3","UV4","MaxUV","Tempo"])
        return df["Tempo"].tolist(), df["Temperatura"].tolist()
